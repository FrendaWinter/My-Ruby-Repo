...
productString = 'Java Development Kit 20 for windows'
...
url = "#{@home_page}/java/technologies/javase/20all-relnotes.html"
...
# Add suffix to all vesion have same format (4 fields: 20 -> 20.0.0.0)
...
@urls << { desc: productString, link: "#{@home_page}/java/technologies/javase/jdk20-archive-downloads.html" }
