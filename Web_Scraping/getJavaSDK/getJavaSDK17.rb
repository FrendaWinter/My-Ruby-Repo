...
productString = 'Java Development Kit 17 for windows'
...
url = "#{@home_page}/java/technologies/javase/17all-relnotes.html"
...
# Add suffix to all vesion have same format (4 fields: 17 -> 17.0.0.0)
...
@urls << { desc: productString + ' - Windows x64 Compressed Archive', link: "https://download.oracle.com/java/17/archive/jdk-#{version}_windows-x64_bin.zip" }
@urls << { desc: productString + ' - Windows x64 Installer', link: "https://download.oracle.com/java/17/archive/jdk-#{version}_windows-x64_bin.exe" }
@urls << { desc: productString + ' - Windows x64 MSI Installer', link: "https://download.oracle.com/java/17/archive/jdk-#{version}_windows-x64_bin.msi" }
